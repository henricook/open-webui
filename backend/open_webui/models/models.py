    ...
    def update_model_by_id(self, id: str, model: ModelForm) -> Optional[ModelModel]:
        try:
            ...
            with get_db() as db:
                ...
                old_system_prompt = existing_model.params.model_dump().get("system") if existing_model and existing_model.params else None
                new_system_prompt = updated_model_data.params.model_dump().get("system") if updated_model_data and updated_model_data.params else None
